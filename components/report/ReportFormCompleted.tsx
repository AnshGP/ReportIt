...
export function ReportSubmitted({ data }: ReportSubmittedProps) {
  ...
  return (
    <div className="text-center space-y-6">
      ...
      <div className="bg-zinc-800/50 rounded-lg max-[320px]-px-6 py-6 max-w-md mx-auto">
        <h4 className="text-white font-medium mb-2">Your Report ID</h4>
        <div className="bg-zinc-900 rounded-md p-2 sm:p-3 md:p-4 lg:p-5 max-w-full overflow-x-auto">
          <code className="text-sky-400 text-sm max-[319px]:text-[10px] sm:text-base md:text-lg break-words">
            {reportId}
          </code>
        </div>
